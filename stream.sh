...
python3 cleaner.py tweet_activity_metrics_sciencepolicy_20180307_20180314_en.csv
awk '{a[i++]=$0} END {for (j=i-1; j>=0;) print a[j--] }' activity.out >> activity.csv

rm -fv *.out tweet_activity_metrics_sciencepolicy_20180307_20180314_en.csv
